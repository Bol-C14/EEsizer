...
from legacy_eesizer import prompts
...
class TestPromptTemplates(unittest.TestCase):
    def test_template_hashes(self):
        expected = {
            ...
            "SIMULATION_FUNCTION_EXPLANATION": "acf0fa08487196fdde172d499f7b069f17367421d37f3d3f55ffab4182990fe9",
...
class TestPromptBuilders(unittest.TestCase):
    def test_builder_hashes(self):
        ...
        expected = {
            ...
            "build_simulation_prompt": "4b818d130d7ca388b465aaed59059496be8dd86527ba1e842228a3f73f9062e1",
