...
""" Variable - tasks_generation_SYSTEM_PROMPT
which is applied for the hard coded system role prompt for task decomposition
...
#%%
""" Inject the task_generation_question and netlist into the prompt template, then ask for tasks"""

#task generation
tasks_generation_prompt = f'''system: {tasks_generation_template},
...
type_identify_prompt = f''' System: {type_question}
Netlist: {netlist},
'''
