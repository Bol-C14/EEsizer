...
## Files touched
- Code: `src/eesizer_core/metrics/aliases.py`, `src/eesizer_core/metrics/__init__.py`, `src/eesizer_core/strategies/baseline_noopt.py`, `src/eesizer_core/baselines/legacy_metrics_adapter.py`, `src/eesizer_core/strategies/patch_loop/strategy.py`
